...
function About() {
    return (
        ...
        font-gotham leading-relaxed font-extrabold lg:border-r-4 lg:border-medGreen lg:pr-20 drop-shadow-lg">
            ...
            or anything else outside with my fiancé <a href={AudRog}
